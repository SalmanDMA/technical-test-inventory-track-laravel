...
<x-dashboard.layout>
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-slate-200 lg:mt-1.5">
        <div class="mb-1 w-full">
            <div class="mb-4">
                <h1 class="text-xl sm:text-2xl font-semibold text-slate-900">Return list</h1>
            </div>
            <div class="flex flex-wrap sm:flex-nowrap">
                <div class="sm:divide-x sm:divide-slate-100 mb-3 sm:mb-0 w-full sm:w-64 xl:w-96">
                    <form class="lg:pr-3" action="{{ route('dashboard.return') }}" method="GET">
                        <label for="return-search" class="sr-only">Search</label>
                        <div class="mt-1 relative w-full">
                            <input type="text" name="search" id="return-search"
                                ...
                                placeholder="Search return by name here...">
                        </div>
                    </form>
                </div>
                <div class="grid grid-cols-2 gap-2 sm:ml-auto w-full sm:max-w-[270px]">
                    <a href="{{ route('dashboard.return.add') }}"
                    ...
                    <form action="{{ route('dashboard.return.export') }}" method="GET">
                        <button type="submit"
