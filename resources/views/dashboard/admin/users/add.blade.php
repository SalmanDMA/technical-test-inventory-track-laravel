            ...
            <div class="rounded-sm border border-slate-300 bg-white shadow-lg">
                <form id="userForm" class="py-4 px-6 flex flex-col gap-4">
                    ...
                    <x-input-field name="email" labelName="Email" placeholder="Enter your email here..."
                        type="text" requiredInput="true" />
                    <x-input-field name="password" labelName="Password" placeholder="Enter your password here..."
                        type="password" requiredInput="true" />
                        ...
                        <div>
                            ...
                            <div class="relative z-20 bg-transparent">
                                <select name="role" id="role"
                                    class="relative z-20 appearance-none w-full rounded-lg border-[1.5px] border-primary bg-transparent px-5 py-3 font-normal text-slate-950 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-slate-300 font-gelasio">
                                    <option value="" class="text-body">
                                        Select role
                                    </option>
                                    <option value="admin" class="text-body">admin</option>
                                    <option value="user" class="text-body">user</option>
                                </select>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(() => {
                                window.location.href = "{{ route('dashboard.users') }}";
                            }, 1000);
                        }
                    },
